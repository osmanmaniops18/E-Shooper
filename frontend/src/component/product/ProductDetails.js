...
dispatch(getProductDetails(id));
  ...
  return (
    <>
        {loading ? <Loader /> :(<>
            <MetaData title={`${product.name} -- E-SHOOPER`} />
            ...
            <div>
                <Carousel>
                    ...
                    product.images.map((items,i)=>(
                        <img  className='CarouselImage' key={items.url} src={items.url} alt={`${i} Slide`}/>  
                    ))
                    }
                </Carousel>
                ...
                <div>
                   ...
                   <p>Product # {product._id}</p>
                    ...
                    <div className='detailsBlock-3'>
                        <h1>${product.price}</h1>
                        <div key={product._id} className='detailsBlock-3-1'>
